        ...
        <div class="row align-items-center min-vh-50">
            <div class="col-lg-6 py-5">
                ...
                <div class="d-flex gap-3 flex-wrap" style="position: relative; z-index: 10;">
                    <a href="<?= url('tentang') ?>" class="btn btn-warning btn-lg px-4 py-3 fs-5"
                        style="position: relative; z-index: 10;">
                        <i class="bi bi-info-circle me-2"></i>Tentang Kami
                    </a>
                    <a href="<?= url('kontak') ?>" class="btn btn-outline-light btn-lg px-4 py-3 fs-5"
                        style="position: relative; z-index: 10;">
            ...
            <div class="col-lg-6 text-center py-5">
                <?php if (setting('hero_image')): ?>
                    <img src="<?= uploads('settings/' . setting('hero_image')) ?>"
                        alt="<?= e(setting('site_name', 'Church')) ?>" class="img-fluid" style="max-height: 400px;">
                <?php else: ?>
                    <img src="<?= asset('images/hero-church.svg') ?>" alt="Church" class="img-fluid"
                        ...
                        <div class="card h-100 shadow-sm border-0">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted fs-5 mb-2">
                                    ...
                                    <?= date('H:i', strtotime($schedule['start_time'])) ?>        <?= $schedule['end_time'] ? ' - ' . date('H:i', strtotime($schedule['end_time'])) : '' ?>
                                    WIB
                                </p>
                                <?php
                ...
                <?php foreach ($events as $event): ?>
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 shadow-sm border-0 overflow-hidden">
                            <?php if ($event['image']): ?>
                                <img src="<?= uploads($event['image']) ?>" class="card-img-top" alt="<?= e($event['title']) ?>"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 shadow-sm border-0 overflow-hidden">
                            <?php if ($article['image']): ?>
                                <img src="<?= uploads($article['image']) ?>" class="card-img-top" alt="<?= e($article['title']) ?>"
                                    style="height: 200px; object-fit: cover;">
                            <?php else: ?>
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex mb-4">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted fs-5 mb-0"><?= e(setting('site_address', 'Jl. Gereja No. 123, Jakarta')) ?>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="ratio ratio-4x3 rounded shadow overflow-hidden">
                    ...
                    if (!empty($gmapsUrl)):
                        ?>
                        <iframe src="<?= e($gmapsUrl) ?>" style="border:0;" allowfullscreen="" loading="lazy">
                        </iframe>
                    <?php else: ?>
