        ...
        <form action="<?= url('admin/members/update/' . $member['id']) ?>" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" 
                           value="<?= e($member['phone']) ?>" placeholder="08xxxxxxxxxx">
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="address" name="address" rows="3"><?= e($member['address']) ?></textarea>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="notes" name="notes" rows="3"><?= e($member['notes']) ?></textarea>
                </div>
            </div>
